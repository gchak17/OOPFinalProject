...
//<<<<<<< HEAD
	public static void sendMessage(String gameId, Message message) {
		...
		// for (Session peer : peers) {
		// if(((HttpSession)
		// peer.getUserProperties().get("HttpSession")).getAttribute("player").toString().equals(artistUsername))
		// {
		...
		// }else {
		// List<Session> peers = sessions.get(gameId);
		// for (Session peer : peers) {public static void sendMessage(String gameId,
		// Message message) {
	...
	private static void sendOnlyToArtist(String gameId, Message message) {
		...
		for (Session peer : peers) {
			if (((Player) ((HttpSession) peer.getUserProperties().get("HttpSession")).getAttribute("player"))
					.isArtist()) {
				System.out.println(
						((Player) ((HttpSession) peer.getUserProperties().get("HttpSession")).getAttribute("player"))
