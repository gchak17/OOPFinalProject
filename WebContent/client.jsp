...
<body>
	...
	<div id="paint-options-panel" class="center-panel">
		...
		<div id="green" onclick="color(this)"
			class="paint-options-panel-colors"></div>
		<div id="blue" onclick="color(this)"
			class="paint-options-panel-colors"></div>
		<div id="red" onclick="color(this)" class="paint-options-panel-colors"></div>
		<div id="yellow" onclick="color(this)"
			class="paint-options-panel-colors"></div>
		<div id="orange" onclick="color(this)"
			class="paint-options-panel-colors"></div>
		<div id="black" onclick="color(this)"
			class="paint-options-panel-colors"></div>
		<div id="gray" onclick="color(this)"
			class="paint-options-panel-colors"></div>
		<div id="purple" onclick="color(this)"
			class="paint-options-panel-colors"></div>
		<div id="brown" onclick="color(this)"
			class="paint-options-panel-colors"></div>
		<div id="aqua" onclick="color(this)"
			class="paint-options-panel-colors"></div>
		...
		<input type="button" value="clear canvas" id="clr" size="23"
			onclick="clearCanvas()">
	</div>
